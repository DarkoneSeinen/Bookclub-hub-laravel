            ...
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div class="flex gap-2">
                        <select wire:model.live="statusFilter" class="border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500 bg-white text-gray-900">
                        ...
                        @forelse($orders as $order)
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm font-mono font-medium text-indigo-600">{{ $order->order_number }}</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    ...
                                    <p class="mt-2 text-gray-500">No se encontraron órdenes</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 mb-4">
                        <h4 class="text-sm font-medium text-gray-700 mb-2">Información del Cliente</h4>
                        <p class="text-gray-900 font-medium">{{ $selectedOrder->user->name ?? 'Usuario eliminado' }}</p>
                        <p class="text-gray-500 text-sm">{{ $selectedOrder->user->email ?? '-' }}</p>
                    </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($selectedOrderItems as $item)
                                        <tr>
                                            <td class="px-4 py-3">
                                                <div class="text-sm font-medium text-gray-900">{{ $item['book_title'] }}</div>
                                ...
                                <tfoot class="bg-gray-50">
                                    <tr>
                                        ...
                                        <td class="px-4 py-3 text-right text-lg font-bold text-emerald-600">${{ number_format($selectedOrder->total_price, 2) }}</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
